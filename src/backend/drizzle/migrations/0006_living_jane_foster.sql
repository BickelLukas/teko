...
INSERT INTO `__new_tasks`("id", "title", "description", "assignee_id", "state", "created_at", "created_by", "archived_at", "recurrence_rule", "recurrence_mode", "completion_window_days", "next_due_at", "planned_for", "points", "tags", "exposed_to_ha", "is_household") SELECT "id", "title", "description", "assignee_id", "state", "created_at", "created_by", "archived_at", "recurrence_rule", "recurrence_mode", "completion_window_days", "next_due_at", "planned_for", "points", "tags", "exposed_to_ha", "is_household" FROM `tasks`;--> statement-breakpoint
